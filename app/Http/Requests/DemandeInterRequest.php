...
class DemandeInterRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'site_cp' => 'required|max:5|numeric',
            'site_ville' => 'required|max:50',
            'site_tel' => 'required|max:10|numeric',
            'site_fax' => 'required|max:10|numeric',
            'site_email' => 'required|email|max:50',
            'cores_info_nom' => 'required|max:50',
            'cores_info_tel' => 'required|max:10|numeric',
            'cores_info_bis_nom' => 'required|max:50',
            'cores_info_bis_tel' => 'required|max:10|numeric',
            'secretariat_nom' => 'required|max:50',
            'secretariat_tel' => 'required|max:10|numeric',
